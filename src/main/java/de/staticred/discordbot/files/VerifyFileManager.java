...
public class VerifyFileManager {
    ...
    public void addPlayerAsUnverified(ProxiedPlayer p) {
        ...
        conf.set(uuid + ".group", PermissionProvider.getGroupName(p.getUniqueId()));
        conf.set(uuid + ".groupPower", PermissionProvider.getGroupJoinPower(PermissionProvider.getGroupName(p.getUniqueId())));
    ...
    public void updateGroupPower(ProxiedPlayer p) {
        conf.set(p.getUniqueId().toString() + ".groupPower", PermissionProvider.getGroupJoinPower(PermissionProvider.getGroupName(p.getUniqueId())));
        saveFile();
    }
    ...
    public void updateRank(ProxiedPlayer p) {
        conf.set(p.getUniqueId().toString() + ".rank",PermissionProvider.getGroupName(p.getUniqueId()));
        saveFile();
    }
    ...
    public int getGroupPower(String discordID) {
        String uuid = getUUIDFromDiscordID(discordID);
        return conf.getInt(uuid + ".groupPower");
    }
